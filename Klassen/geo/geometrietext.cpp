...
{
    QString alter_inhalt = Text.at(zeile);
    Text.edit(zeile, alter_inhalt + PUNKT + TRZ_PA + \
              p.x_QString() + TRZ_PA + \
              p.y_QString() + TRZ_PA + \
              p.z_QString() + TRZ_PA + \
              p.farbe() + TRZ_PA + \
...
{
    QString alter_inhalt = Text.at(zeile);
    Text.edit(zeile, alter_inhalt + STRECKE + TRZ_PA + \
...
{
    QString alter_inhalt = Text.at(zeile);
    Text.edit(zeile, alter_inhalt + BOGEN + TRZ_PA + \
...
{
    QString alter_inhalt = Text.at(zeile);
    Text.edit(zeile, alter_inhalt + KREIS + TRZ_PA + \
...
{
    QString alter_inhalt = Text.at(zeile);
    Text.edit(zeile, alter_inhalt + ZYLINDER + TRZ_PA + \
...
{
    QString alter_inhalt = Text.at(zeile);
    Text.edit(zeile, alter_inhalt + RECHTECK3D + TRZ_PA + \
...
{
    QString alter_inhalt = Text.at(zeile);
    Text.edit(zeile, alter_inhalt + WUERFEL + TRZ_PA + \

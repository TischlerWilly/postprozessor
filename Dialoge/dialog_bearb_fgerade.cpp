...
{
    fraesergerade fg;
    fg.set_xs(berechnen(ui->lineEdit_xs->text()));
    fg.set_ys(berechnen(ui->lineEdit_ys->text()));
    fg.set_zs(berechnen(ui->lineEdit_zs->text()));
    fg.set_xe(berechnen(ui->lineEdit_xe->text()));
    fg.set_ye(berechnen(ui->lineEdit_ye->text()));
    fg.set_ze(berechnen(ui->lineEdit_ze->text()));
